 ...
 * @category	Libraries
 * @author		Geotekh
 * @link		http://geotekh.com/user_guide/libraries/email.html
 */
class mail {

    var $useragent = "geotekh";
     ...
     * @return	void
     */
    public function from($from = EMAIL_FROM, $name = '') {
    ...
    protected function _set_error_message($msg, $val = '') {
        ...
        log_message("error", str_replace('%s', $val, $line) . "<br />");
    }
